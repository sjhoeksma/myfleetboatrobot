...
## [0.7.4]
- No sleep when nextepoch is zero
- Wait till exact time for book moment

## [0.7.3]
- Fixed build issue docker files
- Fixed issue with booking failuere not retry and failing over
